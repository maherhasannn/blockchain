...
var Block = /** @class */ (function () {
    function Block(prevHash, transaction, ts //time stamp
    ) {
        if (ts === void 0) { ts = Date.now(); }
        this.prevHash = prevHash;
        this.transaction = transaction;
        this.ts = ts;
        this.nonce = Math.round(Math.pow((Math.random() * 9999999999), 2) + Math.random() * 32543232);
        this.mine();
    }
    ...
    Block.prototype.mine = function () {
        ...
        console.log("Block mined: ".concat(this.hash, " (nonce: ").concat(this.nonce, ")"));
    };
    return Block;
}());
